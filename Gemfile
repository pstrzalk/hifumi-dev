...
#
# Exact prerelease pin: 2.0 has reached RubyGems only as release candidates so
# far, and BUNDLE_DEPLOYMENT=1 plus HIFUMI_AGENT_IMAGE reusing this image mean
